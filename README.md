...
**桂宁的 Hermes Agent 实用技能库：闲鱼自动化、研究前置协议、求职框架、新能源售后知识管理、沟通系统等。由日常 AI 协作中沉淀的可复用方法论。**

[SkillHub 在线安装](https://skillhub.cn/skills/hermes-skills-collection) · [快速使用](#快速使用) · [核心能力](#核心能力) · [使用边界](#使用边界)
...
```text
使用 hermes-skills-collection 技能。
这是待处理内容，直接执行。
```
...
- 涉及「hermes-skills-collection」的场景任务
- 需要复用已验证方法论的工作
- 批量/复杂任务中的专项环节
